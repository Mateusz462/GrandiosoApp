                ...
                <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0">
                    <li class="nav-item me-3 me-lg-1 active">
                        <a class="nav-link" href="{{ route('home') }}">
                            ...
                            <span class="ms-3 d-lg-none">Strona Główna</span>
                        </a>
                    </li>

                    <li class="nav-item me-3 me-lg-1">
                        <a class="nav-link" href="{{ route('marshing.index') }}">
                            <span><i class="fas fa-flag fa-lg"></i></span>
                            <span class="ms-3 d-lg-none">Musztra</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item me-3 me-lg-1">
                        <a class="nav-link" href="#">
                            ...
                            <span class="ms-3 d-lg-none">Nuty</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item me-3 me-lg-1">
                        <a class="nav-link" href="#">
                            ...
                            <span class="ms-3 d-lg-none">Zakupy</span>
                        </a>
                    </li>

                    <li class="nav-item me-3 me-lg-1">
                        <a class="nav-link" href="{{ route('user.sections.index') }}">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <ul class="navbar-nav flex-row">
                        ...
                        <li class="nav-item dropdown me-3 me-lg-1">
                            <div class="rounded-circle p-1 d-flex align-items-center justify-content-center text-muted" style="width: 38px; height: 38px" type="button" id="firstmenu" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                            ...
                            <ul class="dropdown-menu border-0 shadow p-3" aria-labelledby="firstmenu" style="max-height: 600px; overflow-y: auto; width: 23em; position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-20px, 49px, 0px);" data-popper-placement="bottom- end">
                                ...
                                <!-- admin roles -->
                                <li class="dropdown-item nav-item p-1 my-1 rounded" type="button">
                                    <a href="{{ route('user.sections.index') }}" class="d-flex text-decoration-none text-white">
                                        <i class="fas fa-users bg-gray p-2 rounded-circle"></i>
                                        <div class="ms-3 d-flex justify-content-between align-items-center w-100">
                        ...
                        <!-- profile menu button -->
                        <li class="nav-item dropdown me-3 me-lg-1">
                            <div class="rounded-circle p-1 d-flex align-items-center justify-content-center text-muted" style="width: 38px; height: 38px" type="button" id="usermenu" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">

        ...
        <div class="container-fluid px-4 my-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('roles.index') }}">Rangi</a></li>
    				...
    				<div class="card-body">
                        <div class="row">
                            ...
                            <div class="col text-end">
                                <a href="{{ route('roles.index') }}" class="btn btn-outline-danger"><i class="fas fa-theater-masks"></i> Rangi</a>
                            </div>
                        </div>
                        <!--row-->
                        <div class="mt-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div class="form-group mt-3 @error('name') mt-4 @enderror">
                                                        ...
                                                        <input type="color" id="color" name="color" class="form-control @error('color') is-invalid @enderror" value="{{ old('color') }}" autocomplete="color"/ readonly>
                                                        @error('color')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="form-outline mt-4">
                                                        <input type="text" id="prefix" name="prefix" class="form-control @error('prefix') is-invalid @enderror" value="2" autocomplete="prefix"/ readonly>
